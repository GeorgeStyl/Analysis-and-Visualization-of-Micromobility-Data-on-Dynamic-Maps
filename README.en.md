...
This project provides tools and helper scripts for the analysis and visualization of micromovement data, leveraging PowerFleet APIs, geospatial data, and artificial intelligence techniques. "The data are derived from scooters with a final speed of 50 km/h."
